...
var formatContract = function (data) {
        ...
        var markup = `
                    <div class="m-2">
                                ...
                                <div class="row my-2">
                                    ...
                                    <div class="col-6">
                                        <i class="fa-solid fa-barcode fa-lg"></i> <b>${lajax.t('Reference No')}</b> ${data.reference_number}
                                    </div>
                                </div>

                                <div class="row">
                                    <div class="col-6">
                                        <i class="${data.contract_type_css_class} fa-lg"></i><b> ${lajax.t('Type')}</b> ${data.contract_type}
                                    </div>
                                    <div class="col-6">
                                         <i class="fa-solid fa-file-signature fa-lg"></i></i> <b>${lajax.t('Signature Date')}</b> ${data.contract_date}
                                    </div>
                                </div>
                            </div>                            
                        </div>
...
var formatContractInit = function (data) {
    ...
    {
        var markup =
                '<i class="' + data.contract_type_css_class + ' fa-lg" /></i> ' +
                data.id + ': '  + data.contract_type + ': ' + data.name;
...
var formatContractSelection = function (data) {
    ...
    if (data.selected)
    {
        ...
        return formatContractInit(responseData);
    }
    else
    // return in case of selection
    return formatContractInit(data);
}
