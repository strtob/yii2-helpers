...
class HtmlHelper
{
    ...
    public static function progressBarFileSize($fileSize): string
    {
        ...
        // Define max size in MB (1 GB)
        $maxSizeMb = 1024;
    
        // Calculate progress based on 10-point steps
        $progress = ceil(($sizeMb / $maxSizeMb) * 10) * 10;
    
        // Ensure the progress doesn't exceed 100
        $progress = min($progress, 100);
    
        // Return the progress bar with the calculated progress
